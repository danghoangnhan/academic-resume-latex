...
\includegraphics[width=0.017\linewidth]{imgs/email(1).pdf} danghoangnhan.1@gmail.com                     &                   \\
\includegraphics[width=0.017\linewidth]{imgs/home(1).pdf} \href{http://danghoangnhan.github.io}{danghoangnhan.github.io}                            &                   \\
\includegraphics[width=0.017\linewidth]{imgs/phone(1).pdf} 090-627-6967                                  &                   
\end{tabular}  \\ 
\end{tabular*}
\end{table}
