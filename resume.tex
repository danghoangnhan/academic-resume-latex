...
\resumeItemListStart
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{Project: CRM System}: Enhanced user interfaces and workflows tailored to company needs.
        \item \textbf{Project: Qualification License Management}: Developed a Quality License Management system with automated alerts for expiring licenses, seamlessly integrated with the company's built-in CRM system.
    \end{itemize}
    }
\resumeItemListEnd
